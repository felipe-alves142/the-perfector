...
<body>
    ...
    <form action="includes/pedido.inc.php" method="post">
       ...
       function menuclick(label) {
        ...
        <label for="p1"  class='primary'  onclick="menuclick(this)">
        ...
        <label id ="ps" for="p2" class="primary" onclick="menuclick(this)" > <p>R$ 301,00 à R$ 500,00</p> </label><br>

        <input type="radio" id="p3" name="pedido" value="R$ 501,00 a R$ 800,00">
        <label id="ps1" for="p3" class="primary">R$ 501,00 à R$ 800,00</label><br><br>
        
        <input type="radio" id="p4" name="pedido" value="R$ 1200,00">
        <label id="ps2" for="p4">Mais de R$ 1200,00</label><br> <br>

        <input type="radio" id="p5" name="pedido" value="R$ 801,00 a R$ 1200,00">
        <label id="ps3" for="p5"    >R$801,00 à R$1200,00</label>
