...
<head>
  ...
  <link rel="stylesheet" href="../styles/stylemen.css">
...
<main>
    ...
    <div class="menu menu--closed">
        ...
        <div class="tools tools--hidden">
            ...
            <p class="icon pen" width="32" height="32" >Cliente</p>
            ...
            <a href="includes/logout.inc.php" style="color: black; text-decoration: none;">
